...
<head>
    ...
    <script>
        function validateForm() {
            ...
            const choices = document.querySelectorAll('input[name="choiceDescriptions"]');
            let choiceFilled = false;
            ...
            // Check if a correct choice is selected
            const correctChoices = document.querySelectorAll('input[name="correctChoiceIndex"]:checked');
            correctChoiceSelected = correctChoices.length > 0;

            if (description === "" || !choiceFilled || !correctChoiceSelected) {
                alert('Please fill in all fields and select the correct choice.');
                return false;
            }
            return true;
        }
...
<form action="${pageContext.request.contextPath}/admin/questions/add" method="post" onsubmit="return validateForm()">
    <div>
